...
export default function CosimaMap() {
  ...
  return (
    <div className="bg-[url('https://t3.ftcdn.net/jpg/02/32/81/94/360_F_232819464_VHedOPkRpeQPGtbwXiS4xB2lBQO92B1O.jpg')] w-screen h-screen grid grid-cols-11 grid-row-11">
      {itemsToBeRendered}
    </div>
  );
}
