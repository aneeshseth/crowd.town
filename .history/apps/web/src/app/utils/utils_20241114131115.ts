...
export const DefaultOrionMap: objectState[] = [
  ...
  },
  {
    ...
    isActive: false,
    objectURI:
      "https://static.vecteezy.com/system/resources/previews/042/235/971/non_2x/overhead-view-of-dining-set-with-a-wooden-table-and-beige-chairs-round-table-on-transparent-background-cut-out-furniture-top-view-flat-lay-floor-plan-elements-3d-rendering-png.png",
  },
  {
    type: Objects.toilet,
    gridCol: 3,
