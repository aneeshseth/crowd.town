...
import { DefaultCosimaMap, Users } from "@/app/utils/utils";
...
export default function CosimaMap() {
  ...
  function initRenderDetails() {
    ...
    const isObjectFoundAtInitUserPosition = DefaultCosimaMap.find(
      (object: objectState) =>
    ...
    if (isObjectFoundAtInitUserPosition != null) {
      while (!isFoundInitPositionForUser) {
        ...
        const isObjectFoundAtNewInitUserPosition = DefaultCosimaMap.find(
          (object: objectState) =>
            object.gridRow === userSelected.gridRow && object.gridCol === userSelected.gridCol
        );
  ...
  function onUserMovemenet(e: KeyboardEvent) {
    ...
    const isCollision = DefaultCosimaMap.find(
      (object: objectState) =>
